...
Создал виртуальную машину VirtualBox, используя скачанный образ iso (увы, sway-версию установить не удалось)

![Создание виртуальной машины](image/1.png){#fig:001 width=70%}

## Создание виртуальной машины

Задал объём оперативной памяти — 8555 МБ и количество процессоров - 8. Создал виртуальный жёсткий диск размером 35.22 ГБ

![Настройка параметров машины](image/2.png){#fig:002 width=50%}

## Установка операционной системы

Запустил виртуальную машину. После загрузки LiveCD появляется рабочий стол с предложением установить систему на диск. Нажимаю "Install Fedora Linux..."

![Выбор установки](image/3.png){#fig:003 width=50%}

## Установка операционной системы

Выбираю русский язык интерфейса установщика.

![Выбор языка](image/4.png){#fig:004 width=70%}

## Установка операционной системы

Перед установкой системы диск форматируется.

![Форматирование диска](image/5.png){#fig:005 width=70%}

## Установка операционной системы

Опция шифрования необязательна.
...
Затем, после перезапуска системы, снова выбираю раскладку клавиатуры.
...
![Создание пользователя](image/9.png){#fig:009 width=50%}
...
Устанавливаю development-tools и dkms с помощью dnf
...
Сохраняю файл и перезагружаю систему.
...
Меняю имя хоста и перепроверяю его командой 'hostnamectl'.
...
![Установка texlive](image/18.png){#fig:017 width=50%}

![Установка pandoc-crossref](image/17.png){#fig:018 width=50%}
